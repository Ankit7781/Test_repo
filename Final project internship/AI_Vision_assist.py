...
GEMINI_API_KEY = "AIzaSyA93a_Z6Wa5s_pZmhG5t-t06n5RkGLr5aE"  # Replace with your valid API key
...
st.markdown(
    ...
    <footer style="text-align:center;">
        <p>Powered by <strong>Google Gemini API</strong> | ©️ Ankit | Built with ❤️ using Streamlit</p>
    </footer>
    """,
    unsafe_allow_html=True,
)
